...
public class JwtTokenUtil_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.formento.cadastro.security.component.JwtTokenUtil"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JwtTokenUtil_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.formento.cadastro.util.LocalDateTimeUtil",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.formento.cadastro.security.UsuarioAuthentication", false, JwtTokenUtil_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.springframework.security.core.userdetails.UserDetails", false, JwtTokenUtil_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JwtTokenUtil_ESTest_scaffolding.class.getClassLoader()); 
